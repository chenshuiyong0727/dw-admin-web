<template>
  <div class="page-container">
    ...
    <el-row class="form-flex">
      ...
      <el-col :span="19"><el-input v-model="param.oldPwd" placeholder="原密码" show-password size="small"></el-input></el-col>
    </el-row>
    <el-row class="form-flex">
      <el-col :span="5">新密码：</el-col>
      <el-col :span="19"><el-input v-model="param.newPwd" placeholder="新密码" show-password size="small"></el-input></el-col>
    </el-row>
    <el-row class="form-flex">
      <el-col :span="5">确认密码：</el-col>
      <el-col :span="19"><el-input v-model="param.confirmPwd" placeholder="确认密码" show-password size="small"></el-input></el-col>
    </el-row>
