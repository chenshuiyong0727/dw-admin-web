<template>
  <three-level-route>
    ...
    <el-table height="600" style="margin-top: 20px" border :data="tableData" @selection-change="selected">
      ...
      <el-table-column align="center" prop="id" label="赛程编号" />
      <el-table-column align="center" prop="time" label="时间">
        <template slot-scope="scope">{{scope.row.time | formateTime('{y}-{m}-{d} {h}:{i}') }} </template>
      </el-table-column>
      <el-table-column align="center" prop="homeTeamId" label="主队编号" />
      <el-table-column align="center" prop="homeTeamName" label="主队名称" />
      <el-table-column align="center" prop="guestTeamId" label="客队编号" />
      <el-table-column align="center" prop="guestTeamName" label="客队名称" />
      <el-table-column align="center" prop="events" label="赛事" />
