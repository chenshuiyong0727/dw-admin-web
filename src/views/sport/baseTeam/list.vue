<template>
  <three-level-route>
    ...
    <el-table height="600" style="margin-top: 20px" border :data="tableData"
      ...
      <el-table-column align="center" prop="id" label="球队编号"/>
      <el-table-column align="center" prop="type" label="球队类型">
...
<!--      </el-table-column>-->
      ...
      <el-table-column align="center" label="图片" width="120">
        <template slot-scope="scope">
          <img v-if="scope.row.img" :src="scope.row.img" class="userPic" @click="avatarShow(scope.row.img)" alt="">
          <img v-if="!scope.row.img && scope.row.imgUrl" :src="fileUrl+scope.row.imgUrl" class="userPic" @click="avatarShow(fileUrl+scope.row.imgUrl)" alt="">
        </template>
      </el-table-column>
      <el-table-column align="center" prop="img" label="图片地址-外链"/>
