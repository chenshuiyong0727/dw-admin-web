  ...
  <three-level-route>
    <el-form ref="form">
      <el-row class="query-form">
        <el-col :span="6">
          <el-form-item label="" size="small">
            <el-input v-model.trim="queryParam.userAccount" maxlength="20" placeholder="查询账号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="" size="small">
            <el-input v-model.trim="queryParam.userRealName" maxlength="5" placeholder="查询员工姓名"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="" size="small">
            <el-input v-model.trim="queryParam.departmentName" maxlength="15" placeholder="查询部门"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="" size="small">
      ...
      <el-row v-if="buttonPermissionArr.searchBtn && buttonPermissionArr.searchBtn.length" type="flex" justify="center">
        <el-button v-permission:[buttonPermissionArr.searchBtn]="['查询']" type="primary" size="small" style="margin-right: 10px" @click="search">查询</el-button>
    ...
    <el-table border :data="tableData">
      ...
      <el-table-column fixed="right" align="center" label="操作" width="180" v-if="buttonPermissionArr.listBtn && buttonPermissionArr.listBtn.length">
        <template slot-scope="scope">
          ...
          <el-button type="text" v-permission:[buttonPermissionArr.listBtn]="['重置密码']" @click="resetPwd(scope.row.id)">重置密码</el-button>
