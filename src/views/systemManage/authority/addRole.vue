  ...
  <div class="page-container">
    <el-row class="form-flex">
      ...
      <el-col :span="18" :offset="1">
        <el-select :disabled="modifyId ? true : false" v-model="systemId" @change="changeSystem"
    ...
    <el-row class="form-flex">
      ...
      <el-col :span="18" :offset="1">
        <el-input maxlength="15" v-model="roleName" placeholder="角色名称" size="small"></el-input>
      </el-col>
    </el-row>
      ...
      authorityCheck(v, k) {
        ...
        if (node.checked) {
          if (this.$refs.tree2.getNode(node.parent.data)) {
            let filterNodesArr = this.$refs.tree.getCheckedNodes().concat(
      ...
      getOpSystemList() {
        systemContainerApi.getOpSystemList().then(res => {
          if (res.subCode === 1000) {
            ...
            this.listTreeFunctions(
              this.$route.query.systemId ? this.$route.query.systemId : this.systemId)
          } else {
            this.$message.error(res.subMsg)
          }
        })
