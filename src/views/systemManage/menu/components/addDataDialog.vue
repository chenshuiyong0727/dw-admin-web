      ...
      <el-row :gutter="10">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
          <el-form-item label="权限类型" prop="functionType">
            <el-select v-model="requestParam.functionType" style="width:100%; display:inline-block"
                       size="small">
              <el-option
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
          <el-form-item label="操作类型" prop="operationType">
            <el-select v-model="requestParam.operationType" style="width:100%; display:inline-block"
                       size="small">
              <el-option
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showParentMenu() {
        this.$refs['menu-management-choose'].showMenuChoose(this.requestParam.id,
          this.requestParam.systemId)
      },
      closDialog() {
          ...
          if (this.requestParam.id) {
            systemContainerApi.update(this.requestParam).then((res) => {
              if (res.subCode === 1000) {
                ...
                if (this.requestParam.newpid && this.requestParam.oldpid
                  != this.requestParam.newpid) {
