  ...
  <three-level-route>
    <el-form ref="form">
      <el-row class="query-form">
        ...
        <el-col :span="6">
          <el-form-item label="" size="small">
            <el-input v-model.trim="paramsObj.updateUserName" maxlength="15"
      ...
      <el-row v-if="buttonPermissionArr.searchBtn && buttonPermissionArr.searchBtn.length"
        ...
        <el-button type="primary" size="small" v-permission:[buttonPermissionArr.searchBtn]="['重置']"
                   @click="resetSearchList">重置
        </el-button>
      </el-row>
    </el-form>
    <el-row v-if="buttonPermissionArr.upBtn && buttonPermissionArr.upBtn.length"
      ...
      <el-button type="primary" size="small" @click="addHandle"
                 v-permission:[buttonPermissionArr.upBtn]="['新增']">新增
      </el-button>
    </el-row>
    <el-table height="600" border :data="tableData" v-loading="loading">
      ...
      <el-table-column align="center" prop="otherSuperiorDepartmentName" label="更多层级"
      ...
      <el-table-column align="center" label="操作" width="150"
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" v-permission:[buttonPermissionArr.listBtn]="['启用', '停用']"
                     @click="modifyStatusHandle(scope.row.id, scope.row.dataStatus)">{{
    ...
    methods: {
      ...
      modifyStatusHandle(id, dataStatus) {
        this.$confirm('是否确认进行此状态修改?', '提示', {
          ...
          systemContainerApi.updateDeptStatus({
            id,
            dataStatus: dataStatus == 0 ? 1 : 0,
