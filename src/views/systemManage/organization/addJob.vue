  ...
  <div class="page-container">
    <el-row class="form-flex">
      ...
      <el-col :span="18" :offset="1">
        <el-input maxlength="15" v-model="queryParam.name" placeholder="岗位名称"
                  size="small"></el-input>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="18" :offset="1">
        <el-input maxlength="255" v-model="queryParam.description" type="textarea"
                  :rows="3"></el-input>
      </el-col>
    </el-row>
    <el-row class="form-flex">
    ...
    <el-row class="form-flex">
      ...
      <el-col :span="18" :offset="1" class="cus-select">
        ...
        <el-select multiple v-model="departmentId" style="width:100%; display:inline-block"
                   size="small">
          <el-option
    ...
    <department-tree-dialog v-if="isShowDialog" :departmentTreeData="departmentTreeData"
                            :departmentId="departmentId" :pageType="pageType"
