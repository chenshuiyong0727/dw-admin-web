  ...
  <div class="login-container">
    <div class="top">
      ...
      <el-form ref="loginForm" :model="loginForm" class="login-form" auto-complete="on"
        ...
        <el-button :loading="loading" type="primary" style="width:100%; height: 50px"
  ...
  export default {
    ...
    methods: {
      ...
      handleLogin() {
        ...
        } else if ((this.loginForm.verifyCode && !this.verifyCodeObj)
          || !this.verifyCodeObj.validate(this.loginForm.verifyCode)) {
